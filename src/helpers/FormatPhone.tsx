    ...
    return (
        <div className={className}>
            ...
            <input
                ...
                disabled={disabled}
                className='text-base dark:border-gray-600 disabled:opacity-50 disabled:cursor-not-allowed px-3 py-2 duration-150 border border-gray-500/70 rounded-lg outline-none focus:ring-blue-400 focus:ring-1 w-full transition'
                required={required}
